--TEST--
Quic\ServerConnection compatibility helpers still support single-peer stream exchange
--SKIPIF--
<?php
...
$command = [
    ...
    '-d',
    'extension=' . dirname(__DIR__) . '/modules/quic.so',
    __DIR__ . '/server_listener_compat_integration.php',
];
